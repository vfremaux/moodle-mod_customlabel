...
class customlabel_type_authordata extends customlabel_type{
    ...
    */
    function postprocess_data(){
		...
		if (!empty($this->data->author2)){
			$this->data->author1 = '<ul><li>'.$this->data->author1.'</li>';
			if (!empty($this->data->author3)){
				$this->data->author2 = '<li>'.$this->data->author2.'</li>';
				$this->data->author3 = '<li>'.$this->data->author3.'</li></ul>';
			} else {
				$this->data->author2 = '<li>'.$this->data->author2.'</li></ul>';
			}
		}
    }
}
