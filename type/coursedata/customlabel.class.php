...
class customlabel_type_coursedata extends customlabel_type {
    ...
    public function __construct($data) {
        ...
        $field = new StdClass();
        $field->name = 'showcompetencies';
        $field->type = 'choiceyesno';
        $this->fields['showcompetencies'] = $field;

        $field = new StdClass();
        $field->name = 'competencies';
        $field->type = 'editor';
        $field->itemid = 9;
        $this->fields['competencies'] = $field;
    ...
    public function preprocess_data() {
        ...
        $leftcolumnratio = (empty($this->data->leftcolumnratio)) ? '30%' : $this->data->leftcolumnratio;
        $leftratio = 0 + (int) str_replace('%', '', $leftcolumnratio);
