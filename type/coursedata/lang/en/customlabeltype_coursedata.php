...
$string['defaulttablecaption'] = 'Course information';
$string['duration'] = 'Duration ';
$string['evaluation'] = 'Evaluation mode';
$string['headteacher'] = 'Head teacher&nbsp;';
...
$string['showoutcomes'] = 'Show outcomes';
...
$string['showheadteacher'] = 'Show head teacher';
$string['showlastupdate'] = 'Show last update';
