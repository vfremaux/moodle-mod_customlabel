...
$string['evaluation'] = 'Modes d\'évaluation&nbsp;';
$string['headteacher'] = 'Responsable pédagogique&nbsp;';
...
$string['objectives'] = 'Programme pédagogique&nbsp;';
$string['outcomes'] = 'Validation / Sanction&nbsp;';
...
$string['showoutcomes'] = 'Afficher la validation&ensp;';
...
$string['showheadteacher'] = 'Afficher le/la responsable pédagogique';
$string['showlastupdate'] = 'Afficher la dernière mise à jour';
