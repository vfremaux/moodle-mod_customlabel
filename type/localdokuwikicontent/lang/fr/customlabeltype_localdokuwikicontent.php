...
$string['local_help'] = 'Si le wiki est local, le contenu sera directement lu sur le même serveur que Moodle. Sinon, il sera récupéré par URL. L\'accès local est plus performant.';
