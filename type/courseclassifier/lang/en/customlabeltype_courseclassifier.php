...
$string['pluginname'] = 'Course element : Course index classifier';
$string['courseclassifier'] = 'Course index classification';
$string['tablecaption'] = 'Table caption';
$string['defaulttablecaption'] = 'Classification';
$string['courseclassification'] = 'Course index clasification';
$string['typename'] = 'Course index classifier';
