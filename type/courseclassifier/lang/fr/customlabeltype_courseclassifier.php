...
$string['pluginname'] = 'Element de cours : Classification au catalogue';
$string['courseclassifier'] = 'Classification au catalogue';
$string['tablecaption'] = 'Titre de la table';
$string['defaulttablecaption'] = 'Classification';
$string['typename'] = 'Classification au catalogue';
$string['courseclassification'] = 'Classification au catalogue';
$string['configtypename'] = 'Active le type Classification au catalogue';
