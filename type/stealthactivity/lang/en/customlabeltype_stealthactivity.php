...
$string['stealthactivity:view'] = 'Can view the content';
$string['stealthactivity:addinstance'] = 'Can add an indstance';

$string['pluginname'] = 'Course element: Stealth Activity';
$string['typename'] = 'Stealth Activity';
$string['configtypename'] = 'Enable subtype Stealth Activity';
$string['stealthmodule'] = 'Stealth module';
$string['thumbnail'] = 'Thumbnail';
$string['layout'] = 'Layout';
$string['singleimage'] = 'Single image';
