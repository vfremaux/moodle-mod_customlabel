...
class restore_customlabel_activity_structure_step extends restore_activity_structure_step {
    ...
    protected function process_customlabel_metadatavalue($data) {
    	global $DB;
    ...
    protected function process_customlabel_metadataconstraint($data) {
    	global $DB;
    ...
    protected function process_customlabel_metadatacoursedatum($data) {
    	global $DB;
