...
function type_change_submit2(advicetext, courseid, section, returntomod, sesskey){
	if (confirm(advicetext)){
        url = '/course/mod.php?id='+courseid+'&section='+section+'&sesskey='+sesskey+'&add=customlabel&returntomod='+returntomod+'&type='+ document.getElementById('menulabelclass').options[document.getElementById('menulabelclass').selectedIndex].value;
